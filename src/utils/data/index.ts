...
export const bugData = [
  {
    ...
    concept: 'Aceite',
    definition:
      'Un líquido viscoso y pegajoso que se obtiene de la refinación de los aceites vegetales o animales.',
    description: null,
    enabled: true,
  },
  {
  ...
  },
  {
    ...
    definition:
      'Proceso de desgaste de un cuerpo por el contacto con otro cuerpo y un medio de desgaste.',
    description: null,
    enabled: true,
  },
];
